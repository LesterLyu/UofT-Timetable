...
public class EnrolledCourse {
    ...
    @Expose
    private Object waitlistMeetings;
    ...
    @Expose
    private Integer markApprovedDate;
    @SerializedName("mark")
    @Expose
    private String mark;
     ...
     *     The waitlistMeetings
     */
    public void setWaitlistMeetings(Object waitlistMeetings) {
     ...
     */
    public Integer getMarkApprovedDate() {
     ...
     *     The markApprovedDate
     */
    public void setMarkApprovedDate(Integer markApprovedDate) {
